...
class StatisticsDisplay: Observer, DisplaymentProtocol {
    ...
    func display() {
        print("Current conditions: StatisticsDisplay--temperature:\(temperature)--humidity:\(humidity)--pressure:\(pressure)")
    }
}
